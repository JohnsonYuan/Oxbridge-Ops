...
{
    public partial interface IBonusApp_SettingService
    {
        /// <summary>
        ...
        BonusApp_Setting GetSettingById(int settingId);

        /// <summary>
        /// Deletes a setting
        /// </summary>
        /// <param name="setting">Setting</param>
        void DeleteSetting(BonusApp_Setting setting);

        /// <summary>
        /// Deletes settings
        /// </summary>
        /// <param name="settings">Settings</param>
        void DeleteSettings(IList<BonusApp_Setting> settings);
        ...
        /// <returns>Setting</returns>
        BonusApp_Setting GetSetting(string key, int storeId = 0, bool loadSharedValueIfNotFound = false);
        ...
        IList<BonusApp_Setting> GetAllSettings();
