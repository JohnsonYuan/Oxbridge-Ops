...
namespace Nop.Services.BonusApp.Configuration
{
    /// <summary>
    /// Bonus app setting service
    /// </summary>
    public partial class BonusApp_SettingService : IBonusApp_SettingService
    {
        #region Constants
        ...
        /// Key for caching
        /// </summary>
        private const string SETTINGS_ALL_KEY = "Nop.bonusapp.setting.all";
        /// <summary>
        ...
        private readonly IRepository<BonusApp_Setting> _settingRepository;
        ...
        public BonusApp_SettingService(ICacheManager cacheManager,
            IEventPublisher eventPublisher,
            IRepository<BonusApp_Setting> settingRepository)
        {
        ...
        public virtual void InsertSetting(BonusApp_Setting setting, bool clearCache = true)
        {
            if (setting == null)
        ...
        /// <param name="setting">Setting</param>
        /// <param name="clearCache">A value indicating whether to clear cache after setting update</param>
        public virtual void UpdateSetting(BonusApp_Setting setting, bool clearCache = true)
        {
            if (setting == null)
                throw new ArgumentNullException("setting");
        ...
        /// </summary>
        /// <param name="setting">Setting</param>
        public virtual void DeleteSetting(BonusApp_Setting setting)
        {
            if (setting == null)
                throw new ArgumentNullException("setting");
        ...
        public virtual void DeleteSettings(IList<BonusApp_Setting> settings)
        {
            if (settings == null)
        ...
        public virtual BonusApp_Setting GetSettingById(int settingId)
        {
            if (settingId == 0)
                return null;
        ...
        /// <returns>Setting</returns>
        public virtual BonusApp_Setting GetSetting(string key, int storeId = 0, bool loadSharedValueIfNotFound = false)
        {
        ...
        public virtual void SetSetting<T>(string key, T value, int storeId = 0, bool clearCache = true)
        {
            ...
            {
                //insert
                var setting = new BonusApp_Setting
                {
                    Name = key,
                    Value = valueStr,
                    StoreId = storeId
        ...
        /// </summary>
        /// <returns>Settings</returns>
        public virtual IList<BonusApp_Setting> GetAllSettings()
        {
